...
apollo_config_db_url=jdbc:mysql://47.100.221.78:3306/ApolloConfigDB?characterEncoding=utf8
apollo_config_db_username=apollo
apollo_config_db_password=!QAZ2wsx

# apollo portal db info
apollo_portal_db_url=jdbc:mysql://47.100.221.78:3306/ApolloPortalDB?characterEncoding=utf8
apollo_portal_db_username=apollo
apollo_portal_db_password=!QAZ2wsx
